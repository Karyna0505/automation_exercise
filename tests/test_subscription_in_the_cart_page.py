...
class TestSubscriptionInTheCartPage:
    ...
    def test_subscription_cart_page(self, test_setup):
        """
        Test to verify Subscription in Cart page.
        ...
        take_screenshot(self.page, "subscription_in_cart_page")
